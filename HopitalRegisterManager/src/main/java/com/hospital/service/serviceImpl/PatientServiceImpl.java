...
public class PatientServiceImpl implements PatientService {
    ...
    public Boolean deletePatient(int pId) {
        ...
        patient.setPId(String.valueOf(pId));
        //patient.setPState(0);
     ...
     */
    @Override
    public int changePatientById(String pId, String pName, String pPhone) {
        return patientMapper.changePatientById(pId, pName, pPhone);
    }
