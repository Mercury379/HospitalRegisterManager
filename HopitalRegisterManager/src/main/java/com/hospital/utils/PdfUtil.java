...
public class PdfUtil {
    ...
    public static void ExportPdf(HttpServletRequest request, HttpServletResponse response, Orders order) throws Exception {
       ...
       // response.setHeader("Content-Disposition", "attachment;filename=XXX.pdf");
        ...
        tableMessage.addCell(new Paragraph(21 +" 岁", FontChinese));
        tableMessage.addCell(new Paragraph("单号", FontChinese));
        tableMessage.addCell(String.valueOf(order.getOId()));
        tableMessage.addCell(new Paragraph("时间", FontChinese));
        tableMessage.addCell(String.valueOf(order.getORegisterTime()));
        ...
        cell3.setBorder(0);
        PdfPCell cell4 = new PdfPCell(new Paragraph(order.getOItem(), new Font(bfChinese, 10, Font.NORMAL)));
        ...
        PdfPCell cell9 = new PdfPCell(new Paragraph("所用牙科材料及价钱", new Font(bfChinese, 14, Font.NORMAL)));
        cell9.setFixedHeight(25);
        cell9.setBorder(0);
        PdfPCell cell10 = new PdfPCell(new Paragraph(order.getOMaterial(), new Font(bfChinese, 10, Font.NORMAL)));
